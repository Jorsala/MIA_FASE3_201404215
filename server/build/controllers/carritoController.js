...
class CarritoController {
    ...
    createDetalleCarrito(req, res) {
        oracledb_1.default.getConnection(keys_1.default.database, function (err, connection) {
            ...
            connection.execute("INSERT INTO DETALLE_CARRITO(NOMBRE,CANTIDAD,PRECIO,SUBTOTAL,PRODUCTO_ID_PRODUCTO,CARRITO_ID_CARRITO) VALUES " +
                "(:NOMBRE, :CANTIDAD,:PRECIO, :SUBTOTAL,:PRODUCTO_ID_PRODUCTO,:CARRITO_ID_CARRITO) ", [req.body.NOMBRE, req.body.CANTIDAD, req.body.PRECIO, req.body.SUBTOTAL, req.body.PRODUCTO_ID_PRODUCTO, req.body.CARRITO_ID_CARRITO], {
                autoCommit: true,
                outFormat: oracledb_1.default.OBJECT // Return the result as Object                      
            }, function (err, result) {
                if (err) {
    ...
    updateCarrito(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield oracledb_1.default.getConnection(keys_1.default.database, function (err, connection) {
                ...
                connection.execute("UPDATE CARRITO set TOTAL =:TOTAL WHERE ID_CARRITO = :ID_CARRITO", [req.body.TOTAL, req.params.id], {
                    autoCommit: true,
                    outFormat: oracledb_1.default.OBJECT
                }, function (err, result) {
                    if (err || result.rowsAffected === 0) {
    ...
    updatedetallecarrito(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield oracledb_1.default.getConnection(keys_1.default.database, function (err, connection) {
                ...
                //console.log(req.body)
                connection.execute("UPDATE DETALLE_CARRITO set CANTIDAD =:CANTIDAD , SUBTOTAL =:SUBTOTAL WHERE CARRITO_ID_CARRITO=:CARRITO_ID_CARRITO AND PRODUCTO_ID_PRODUCTO = :id", [req.body.CANTIDAD, req.body.SUBTOTAL, req.body.CARRITO_ID_CARRITO, req.params.id], {
                    autoCommit: true,
                    outFormat: oracledb_1.default.OBJECT
                }, function (err, result) {
                    if (err || result.rowsAffected === 0) {
    ...
    enviarFactura(req, res) {
        ...
        let mailOptions = {
            from: 'Jorge <canchemolinas@gmail.com>',
            to: req.body.CORREO,
            subject: 'Factura de compra realizada en publishes and sells',
            text: 'Factura',
