    ...
    create(req, res) {
        oracledb_1.default.getConnection(keys_1.default.database, function (err, connection) {
            ...
            connection.execute("INSERT INTO usuario(NOMBRE, APELLIDO,CORREO, CLAVE_ACCESO, TELEFONO," +
                ...
                ":FOTOGRAFIA, :GENERO, :FECHA_NACIMIENTO, :FECHA_REGISTRO, :DIRECCION, :CREDITO_DISPONIBLE, :GANANCIA_OBTENIDA," +
                ":ESTADO, :ROL_ID_ROL, :CLASE_CLIENTE_ID ) ", [req.body.NOMBRE, req.body.APELLIDO, req.body.CORREO, req.body.CLAVE_ACCESO,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            yield oracledb_1.default.getConnection(keys_1.default.database, function (err, connection) {
                ...
                connection.execute("UPDATE usuario set NOMBRE =:NOMBRE , APELLIDO =:APELLIDO , CORREO=:CORREO ,CLAVE_ACCESO =:CLAVE_ACCESO " +
                    ...
                    "CREDITO_DISPONIBLE=:CREDITO_DISPONIBLE ,ESTADO=:ESTADO,ROL_ID_ROL=:ROL_ID_ROL,CLASE_CLIENTE_ID=:CLASE_CLIENTE_ID WHERE ID_USUARIO = :ID_USUARIO", [req.body.NOMBRE, req.body.APELLIDO, req.body.CORREO, req.body.CLAVE_ACCESO,
    ...
    updatecliente(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield oracledb_1.default.getConnection(keys_1.default.database, function (err, connection) {
                ...
                let now1 = new Date(req.body.FECHA_NACIMIENTO);
                connection.execute("UPDATE usuario set NOMBRE =:NOMBRE , APELLIDO =:APELLIDO , CORREO=:CORREO ,CLAVE_ACCESO =:CLAVE_ACCESO " +
                    ",TELEFONO =:TELEFONO,FOTOGRAFIA=:FOTOGRAFIA,GENERO=:GENERO,FECHA_NACIMIENTO=:FECHA_NACIMIENTO ,DIRECCION=:DIRECCION WHERE ID_USUARIO = :id", [req.body.NOMBRE, req.body.APELLIDO, req.body.CORREO, req.body.CLAVE_ACCESO,
